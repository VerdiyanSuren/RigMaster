...
namespace vufRM
{
	...
	private:
		struct vufEffectors
		{
			...
			vufMath::vufVector_4d		m_translate_l;
			vufMath::vufVector_4d		m_translate_w;
			vufMath::vufVector_4d		m_scale_dir_x;
			vufMath::vufVector_4d		m_scale_dir_y;
			vufMath::vufVector_4d		 m_scale_dir_z;
	...
	private:
		...
		inline double compute_input_matrix_param( const std::vector<vufMath::vufMatrix_4d>& p_in_array, unsigned int p_xfrms_count);
		inline void compute_dirs_for_effectors_local();
		inline void compute_dirs_for_effectors_world();
