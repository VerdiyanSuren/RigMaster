#ifndef VF_TP_CRV_INCLUDE_H
#define VF_TP_CRV_INCLUDE_H

#include "vufGlobalIncludes.h"
#pragma region REBUILD_ROUTINES 

#define VF_TP_CRV_NODE_DECLARE_REBUILD_ATTR()		\
...
#define VF_TP_CRV_NODE_DEFINE_REBUILD_ATTR(CLASS_NAME)	\
...
#define VF_TP_CRV_NODE_INIT_REBUILD_ATTR()																\
	...
	CHECK_MSTATUS(l_enum_attr_fn.setStorable(true));													\
																										\
	/* Samples */																						\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_samples_attr, samples, smp, kInt, 5);							\
	CHECK_MSTATUS(l_numeric_attr_fn.setMin(2));															\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_clamp_start_attr, clampStart, bst, kBoolean, false);			\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_clamp_start_value_attr, clampStartValue, bsv, kDouble, 0.0);	\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_clamp_end_attr, clampEnd, bnd, kBoolean, false);				\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_clamp_end_value_attr, clampEndValue, bnv, kDouble, 0.0);		\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_rebuild_offset_attr, rebuildOffset, bof, kDouble, 0.0);		\
	/* Rebuild Compound */																				\
...
#define VF_TP_CRV_NODE_REBUILD_ATTR_AFFECT_TO(ATTR)															\
...
l_rbld_offset
*/
#define VF_TP_CRV_NODE_READ_REBUILD_ATTR()														\
...
#define VF_TP_CRV_NODE_DECLARE_QUATERNIONS_ATTR()		\
...
#define VF_TP_CRV_NODE_DEFINE_QUATERNIONS_ATTR(CLASS_NAME)	\
...
#define VF_TP_CRV_NODE_INIT_QUATERNIONS_ATTR()																		\
	/** Assume 	l_status l_enum_attr_fn l_compound_attr_fn	l_numeric_attr_fn is already declared*/					\
	...
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_quaternion_pin_start_attr, rotationPinStart, rsp, kBoolean, false);		\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_quaternion_pin_start_value_attr, rotaionPinStartValue, rsv, kDouble, 0.0);	\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_quaternion_pin_end_attr, rotationPinEnd, rnp, kBoolean, false);			\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_quaternion_pin_end_value_attr, rotationPinEndValue, rnv, kDouble, 1.0);	\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_quaternion_offset_attr, rotationOffset, rof, kDouble, 0.0);				\
	/* Quaternion Compound */																						\
...
#define VF_TP_CRV_NODE_QUATERNIONS_ATTR_AFFECT_TO(ATTR)																\
...
l_quat_offset_value
*/
#define VF_TP_CRV_NODE_READ_QUATERNIONS_ATTR()															\
...
#define VF_TP_CRV_NODE_DECLARE_SCALE_ATTR()				\
...
#define VF_TP_CRV_NODE_DEFINE_SCALE_ATTR(CLASS_NAME)		\
...
#define VF_TP_CRV_NODE_INIT_SCALE_ATTR()																			\
	/** Assume 	l_status l_enum_attr_fn l_compound_attr_fn	l_numeric_attr_fn is already declared*/					\
	...
	CHECK_MSTATUS(l_enum_attr_fn.setStorable(true));																\
																													\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_scale_pin_start_attr, scalePinStart, ssp, kBoolean, false);				\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_scale_pin_start_value_attr, scaleinStartValue, ssv, kDouble, 0.0);			\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_scale_pin_end_attr, scalePinEnd, snp, kBoolean, false);					\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_scale_pin_end_value_attr, scalePinEndValue, snv, kDouble, 1.0);			\
	VF_TP_CREATE_STORABLE_NUMERIC_ATTR(g_scale_offset_attr, scaleOffset, sof, kDouble, 0.0);						\
																													\
...
#define VF_TP_CRV_NODE_SCALE_ATTR_AFFECT_TO(ATTR)																\
...
#define VF_TP_CRV_NODE_READ_SCALE_ATTR()															\
