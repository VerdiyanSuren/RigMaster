...
// Curve Data
const MTypeId	mpxCurveWrapper::			g_id(0x297830);	const MString	mpxCurveWrapper::			g_type_name("CurveData");
// Curve locator
const MTypeId	vufCurveLocator::			g_id(0x297930);	const MString	vufCurveLocator::			g_type_name("vufCurveLocator"); const MString	vufCurveLocator::g_drawDb_classification("drawdb/geometry/vufRMCurveLocator");
// Curve Nodes
const MTypeId	vufFromMayaCurveNode::		g_id(0x298030);	const MString	vufFromMayaCurveNode::		g_type_name("vufCurveFromMaya");
const MTypeId	vufCurveToMayaNode::		g_id(0x298130);	const MString	vufCurveToMayaNode::		g_type_name("vufCurveToMaya");
const MTypeId	vufCurveBSplineNode::		g_id(0x298230);	const MString	vufCurveBSplineNode::		g_type_name("vufCurveBSpline");
const MTypeId	vufCurveBlendNode::			g_id(0x298330);	const MString	vufCurveBlendNode::			g_type_name("vufCurveBlend");
const MTypeId	vufCurveNullNode::			g_id(0x298430);	const MString	vufCurveNullNode::			g_type_name("vufCurveNull");
const MTypeId	vufCurveGetTransformNode::	g_id(0x298530);	const MString	vufCurveGetTransformNode::	g_type_name("vufCurveGetXForm");
const MTypeId	vufCurveClosestPointNode::	g_id(0x298630);	const MString	vufCurveClosestPointNode::	g_type_name("vufCurveClosestPoint");
