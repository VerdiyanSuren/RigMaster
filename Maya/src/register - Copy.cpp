...
const MTypeId	vufCurveBSplineNode::		g_id(0x299230);	const MString	vufCurveBSplineNode::		g_type_name("vfCrvBSpline");
const MTypeId	vufCurveBezierNode::		g_id(0x299330);	const MString	vufCurveBezierNode::		g_type_name("vfCrvBezier");
const MTypeId	vufCurveNoiseNode::			g_id(0x299430);	const MString	vufCurveNoiseNode::			g_type_name("vfCrvNoise");
const MTypeId	vufCurveSlideNode::			g_id(0x299530);	const MString	vufCurveSlideNode::			g_type_name("vfCrvSlide");
const MTypeId	vufCurveBlendNode::			g_id(0x299630);	const MString	vufCurveBlendNode::			g_type_name("vfCrvBlend");
const MTypeId	vufCurveComposeNode::		g_id(0x299730);	const MString	vufCurveComposeNode::		g_type_name("vfCrvCompose");
const MTypeId	vufCurveSwitch::			g_id(0x299830);	const MString	vufCurveSwitch::			g_type_name("vfCrvSwitch");

const MTypeId	vufCurveNullNode::			g_id(0x299930);	const MString	vufCurveNullNode::			g_type_name("vfCrvNull");

const MTypeId	vufCurveGetTransformNode::	g_id(0x300030);	const MString	vufCurveGetTransformNode::	g_type_name("vfCrvGetXForm");
const MTypeId	vufCurveClosestParamNode::	g_id(0x300130);	const MString	vufCurveClosestParamNode::	g_type_name("vfCrvClosestParam");
const MTypeId	vufCurveComponentParamNode::g_id(0x300230);	const MString	vufCurveComponentParamNode::g_type_name("vfCrvCompomentParam");
const MTypeId	vufCurveQuatCloseNode::		g_id(0x300330);	const MString	vufCurveQuatCloseNode::		g_type_name("vfCrvRotateClosest");
const MTypeId	vufCurveQuatFrameNode::		g_id(0x300430);	const MString	vufCurveQuatFrameNode::		g_type_name("vfCrvRotateFrame");
const MTypeId	vufCurveQuat2EndsNode::		g_id(0x300530);	const MString	vufCurveQuat2EndsNode::		g_type_name("vfCrvRotate2Ends");
const MTypeId	vufCurveQuatParamNode::		g_id(0x300630);	const MString	vufCurveQuatParamNode::		g_type_name("vfCrvRotateParams");
